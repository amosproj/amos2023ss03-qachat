...
if __name__ == '__main__':
    ...
    with open("answers.txt", "w") as file:
        ...
        questions = ["What does Kadi like to do?", "Is Hafidz better in playing tennis than Amela?",
                     "Who has a red cat?",
                     "Who can play computer games?"]

        context = ["Emanuel has a red cat", "Hafidz has a green car", "Jesse has a blue computer", "Felix has a dog",
                   "Kadi likes to swim", "Amela likes to play tennis and plays tennis better than Hafidz"]

        for question in questions:
            answer = qabot.answer_question_with_context(question, context)
            file.write(f"{question};{answer}\n")

        questions = ["Do we eat noodles for dinner?",
        ...
        questions = ["What is the mission of QAware?",
